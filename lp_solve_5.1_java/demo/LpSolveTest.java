...
public class LpSolveTest extends TestCase {
	...
	public void testVersion() throws Exception {
		...
		assertEquals(1, info.getMinorversion());
	...
	*/
	...
	public void testAddColumnex() throws Exception {
		...
		assertEquals(0, col[0], 0.0);
		assertEquals(1.5, col[1], 0.0);
		assertEquals(0, col[2], 0.0);
		assertEquals(3.5, col[3], 0.0);
		problem.deleteLp();
	}
	...
	public void testSetColumn() throws Exception {
		...
		assertEquals(1, problem.getNcolumns());
		double[] col = problem.getPtrColumn(1);
		assertEquals(1, col[0], 0.0);
		assertEquals(2, col[1], 0.0);
		assertEquals(3, col[2], 0.0);
		assertEquals(4, col[3], 0.0);
		double[] newcol = { 5, 6, 7, 8 };
		problem.setColumn(1, newcol);
		col = problem.getPtrColumn(1);
		assertEquals(5, col[0], 0.0);
		assertEquals(6, col[1], 0.0);
		assertEquals(7, col[2], 0.0);
		assertEquals(8, col[3], 0.0);
		problem.deleteLp();
	}
	...
	public void testSetColumnex() throws Exception {
		...
		col = problem.getPtrColumn(1);
		assertEquals(0, col[0], 0.0);	// unspecified values are set to zero !?
		assertEquals(6, col[1], 0.0);
		assertEquals(0, col[2], 0.0);
		assertEquals(8, col[3], 0.0);	// unspecified values are set to zero !?
		problem.deleteLp();
	}
	...
	public void testSetRow() throws Exception {
		...
		assertEquals(1, ptrRow[1], 0.0);
		assertEquals(2, ptrRow[2], 0.0);
		double[] newRow = { 0, 5, 6, 7, 8 };	// element 0 is unused
		problem.setRow(1, newRow);
		ptrRow = problem.getPtrRow(1);
		assertEquals(5, ptrRow[1], 0.0);
		assertEquals(6, ptrRow[2], 0.0);
		problem.deleteLp();
	}
	...
	public void testSetRowex() throws Exception {
		...
		assertEquals(1, ptrRow[1], 0.0);
		assertEquals(2, ptrRow[2], 0.0);
		assertEquals(3, ptrRow[3], 0.0);
		assertEquals(4, ptrRow[4], 0.0);
		double[] newRow = { 5, 7 };
		int[] colno = { 1, 3 };
		problem.setRowex(1, 2, newRow, colno);
		ptrRow = problem.getPtrRow(1);
		assertEquals(5, ptrRow[1], 0.0);
		assertEquals(0, ptrRow[2], 0.0);	// unspecified values are set to 0
		assertEquals(7, ptrRow[3], 0.0);
		assertEquals(0, ptrRow[4], 0.0);
		problem.deleteLp();
	}
	...
	public void testGetSetScalelimit() throws Exception {
		LpSolve problem = LpSolve.makeLp(0, 0);
		assertEquals(5, problem.getScalelimit(), 0.0);	// default
		problem.setScalelimit(10);
		assertEquals(10, problem.getScalelimit(), 0.0);
		problem.deleteLp();
	}
	...
	public void testSetFree() throws Exception {
		...
		assertFalse(problem.isFree(1));
		problem.setFree(1);
		assertTrue(problem.isFree(1));
		problem.deleteLp();
	}
	...
	public void testGetSetUpbo() throws Exception {
		LpSolve problem = LpSolve.makeLp(0, 2);
		assertEquals(1E30, problem.getUpbo(1), 0.0);	// default
		problem.setUpbo(1, 1234);
		assertEquals(1234, problem.getUpbo(1), 0.0);
		problem.deleteLp();
	}
	
	public void testGetSetLowbo() throws Exception {
		LpSolve problem = LpSolve.makeLp(0, 2);
		assertEquals(0.0, problem.getLowbo(1), 0.0);	// default
		problem.setLowbo(1, -1234);
		assertEquals(-1234, problem.getLowbo(1), 0.0);
		problem.deleteLp();
	}
	...
	public void testSetBounds() throws Exception {
		...
		assertEquals(-1234, problem.getLowbo(1), 0.0);
		assertEquals(5555, problem.getUpbo(1), 0.0);
		problem.deleteLp();
	}
	...
	public void testGetRow() throws Exception {
		...
		assertEquals(3, row[1], 0.0);
		for (int i = 0; i < size; i++) {
			assertEquals(row[i], ptrRow[i], 0.0);
		}
		problem.deleteLp();
	}
	...
	public void testGetColumn() throws Exception {
		...
		assertEquals(2, column[0], 0.0);
		for (int i = 0; i < size; i++) {
			assertEquals(column[i], ptrColumn[i], 0.0);
		}
		problem.deleteLp();
	}
	...
	public void testAddConstraintex() throws Exception {
		...
		assertEquals(1.5, row[1], 0.0);
		assertEquals(0.0, row[2], 0.0);
		assertEquals(3.5, row[3], 0.0);
		problem.deleteLp();
	}
	...
	public void testSetObjFn() throws Exception {
		...
		assertEquals(1, objFn[1], 0.0);
		assertEquals(-2, objFn[2], 0.0);
		assertEquals(3, objFn[3], 0.0);
		assertEquals(-4, objFn[4], 0.0);
		
		problem.setObjFn(new double[] {0, 9, -8, 7, -6});
		objFn = problem.getPtrRow(0);
		assertEquals(9, objFn[1], 0.0);
		assertEquals(-8, objFn[2], 0.0);
		assertEquals(7, objFn[3], 0.0);
		assertEquals(-6, objFn[4], 0.0);
		problem.deleteLp();
	}
	...
	public void testSetObjFnex() throws Exception {
		...
		assertEquals(5, row.length);
		assertEquals(1.5, row[2], 0.0);
		assertEquals(0.0, row[3], 0.0);
		assertEquals(3.5, row[4], 0.0);
		problem.deleteLp();
	}
	...
	*/
	...
	public void testGetSetMat() throws Exception {
		LpSolve problem = LpSolve.makeLp(3, 4);
		assertEquals(0.0, problem.getMat(1, 1), 0.0);	// default
		problem.setMat(1, 1, 0.5);
		assertEquals(0.5, problem.getMat(1, 1), 0.0);
		problem.deleteLp();
	}
	...
	public void testGetSetAntiDegen() throws Exception {
		LpSolve problem = LpSolve.makeLp(3, 4);
		assertEquals(true, problem.isAntiDegen(LpSolve.ANTIDEGEN_NONE));	// default
	...
	public void testGetSetPresolve() throws Exception {
		...
		problem.setPresolve(LpSolve.PRESOLVE_ROWS | LpSolve.PRESOLVE_COLS);
	...
	public void testGetSetMaxNumInv() throws Exception {
		LpSolve problem = LpSolve.makeLp(3, 4);
		assertEquals(42, problem.getMaxpivot());	// default
	...
	public void testGetSetBbRule() throws Exception {
		LpSolve problem = LpSolve.makeLp(3, 4);
		assertEquals(LpSolve.NODE_FIRSTSELECT, problem.getBbRule());	// default
	...
	public void testGetSetObjBound() throws Exception {
		LpSolve problem = LpSolve.makeLp(3, 4);
		assertEquals(problem.getInfinite(), problem.getObjBound(), 0.0);	// default
		problem.setObjBound(1234.56);
		assertEquals(1234.56, problem.getObjBound(), 0.0);
		problem.deleteLp();
	}

	public void testGetSetFloorFirst() throws Exception {
		LpSolve problem = LpSolve.makeLp(3, 4);
		assertEquals(LpSolve.BRANCH_FLOOR, problem.getBbFloorfirst());	// default
		problem.setBbFloorfirst(LpSolve.BRANCH_AUTOMATIC);
		assertEquals(LpSolve.BRANCH_AUTOMATIC, problem.getBbFloorfirst());
		problem.deleteLp();
	}
	
	public void testGetRowGetColumn() throws Exception {
		LpSolve problem = LpSolve.makeLp(3, 4);
		double[] row = problem.getPtrRow(1);
		assertEquals(5, row.length);
		double[] column = problem.getPtrColumn(1);
	...
	public void testGetObjectiveGetSolution() throws Exception {
		...
		assertEquals(-4.0, problem.getObjective(), 0.0);
		...
		assertEquals(0.0, solution[firstVar + 0], 0.0);
		assertEquals(0.0, solution[firstVar + 1], 0.0);
		assertEquals(2.0, solution[firstVar + 2], 0.0);
		assertEquals(0.0, solution[firstVar + 3], 0.0);
		problem.deleteLp();
	}
	...
	public void testVarDualresult() throws Exception {
		...
		problem.setVerbose(LpSolve.IMPORTANT);
		problem.solve();
		assertEquals(4.0, problem.getVarPrimalresult(1), 0.0);
		assertEquals(0.0, problem.getVarDualresult(1), 0.0);
		problem.deleteLp();
	}
	...
	public void testGetPtrVariables() throws Exception {
		...
		assertEquals(0.0, var[0], 0.0);
		assertEquals(0.0, var[1], 0.0);
		assertEquals(2.0, var[2], 0.0);
		assertEquals(0.0, var[3], 0.0);
		problem.deleteLp();
	}
	...
	public void testGetPtrConstraints() throws Exception {
		...
		assertEquals(4.0, var[0], 0.0);
		assertEquals(6.0, var[1], 0.0);
		problem.deleteLp();
	}
	...
	public void testRhVec() throws Exception {
		...
		problem.strAddConstraint("3 2 2 1", LpSolve.LE, 4);
		problem.strAddConstraint("0 4 3 1", LpSolve.GE, 3);
		assertEquals(4.0, problem.getRh(1), 0.0);
		assertEquals(3.0, problem.getRh(2), 0.0);
		problem.strSetRhVec("1 2");
		assertEquals(1.0, problem.getRh(1), 0.0);
		assertEquals(2.0, problem.getRh(2), 0.0);
		problem.setRhVec(new double[] {0.0, 6.0, 7.5});
		assertEquals(6.0, problem.getRh(1), 0.0);
		assertEquals(7.5, problem.getRh(2), 0.0);
		problem.deleteLp();
	}		
	...
	*/
	...
	public void testRhRange() throws Exception {
		...
		assertEquals(20.5, problem.getRhRange(1), 0.0);
		problem.deleteLp();
	}		
	...
	public void testEpsint() throws Exception {
		LpSolve problem = LpSolve.makeLp(0, 4);
		assertEquals(1E-7, problem.getEpsint(), 0.0);	// default
		problem.setEpsint(0.0001);
		assertEquals(0.0001, problem.getEpsint(), 0.0);
		problem.deleteLp();
	}

	public void testEpsb() throws Exception {
		LpSolve problem = LpSolve.makeLp(0, 4);
		assertEquals(1e-10, problem.getEpsb(), 0.0);	// default
		problem.setEpsb(0.0001);
		assertEquals(0.0001, problem.getEpsb(), 0.0);
		problem.deleteLp();
	}		

	public void testEpsd() throws Exception {
		LpSolve problem = LpSolve.makeLp(0, 4);
		assertEquals(1e-9, problem.getEpsd(), 0.0);	// default
		problem.setEpsd(0.0001);
		assertEquals(0.0001, problem.getEpsd(), 0.0);
		problem.deleteLp();
	}		
	
	public void testEpsel() throws Exception {
		LpSolve problem = LpSolve.makeLp(0, 4);
		assertEquals(1e-12, problem.getEpsel(), 0.0);	// default
		problem.setEpsel(0.0001);
		assertEquals(0.0001, problem.getEpsel(), 0.0);
		problem.deleteLp();
	}		
	
	public void testEpspivot() throws Exception {
		LpSolve problem = LpSolve.makeLp(0, 4);
		assertEquals(2e-7, problem.getEpspivot(), 0.0);	// default
		problem.setEpspivot(0.0001);
		assertEquals(0.0001, problem.getEpspivot(), 0.0);
		problem.deleteLp();
	}		
	
	public void testEpsperturb() throws Exception {
		LpSolve problem = LpSolve.makeLp(0, 4);
		assertEquals(1e-5, problem.getEpsperturb(), 0.0);	// default
		problem.setEpsperturb(0.0001);
		assertEquals(0.0001, problem.getEpsperturb(), 0.0);
		problem.deleteLp();
	}		
	...
	public void testMipGap() throws Exception {
		LpSolve problem = LpSolve.makeLp(0, 4);
		assertEquals(1E-9, problem.getMipGap(true), 0.0);
		problem.setMipGap(true, 0.0001);
		assertEquals(0.0001, problem.getMipGap(true), 0.0);
		problem.deleteLp();
	}	

	public void testVarBranch() throws Exception {
		LpSolve problem = LpSolve.makeLp(0, 4);
		assertEquals(LpSolve.BRANCH_FLOOR, problem.getVarBranch(1));
	...
	public void testBreakAtValue() throws Exception {
		LpSolve problem = LpSolve.makeLp(0, 4);
		assertEquals(- problem.getInfinite(), problem.getBreakAtValue(), 0.0);
		problem.setBreakAtValue(-1.2E22);
		assertEquals(-1.2E22, problem.getBreakAtValue(), 0.0);
		problem.deleteLp();
	}	

	public void testScaling() throws Exception {
		LpSolve problem = LpSolve.makeLp(0, 4);
		assertEquals(LpSolve.SCALE_NONE, problem.getScaling());	// default
	...
	public void testImprove() throws Exception {
		LpSolve problem = LpSolve.makeLp(0, 4);
		assertEquals(LpSolve.IMPROVE_NONE, problem.getImprove());
		problem.setImprove(LpSolve.IMPROVE_FTRAN);
		assertEquals(LpSolve.IMPROVE_FTRAN, problem.getImprove());
		problem.deleteLp();
	}	
	...
	public void testNegrange() throws Exception {
		LpSolve problem = LpSolve.makeLp(0, 4);
		assertEquals(-1000000, problem.getNegrange(), 0.0); // default
		problem.setNegrange(-1.234);
		assertEquals(-1.234, problem.getNegrange(), 0.0);
		problem.deleteLp();
	}	
	...
	public void testBasis() throws Exception {
		...
		// TODO: check later
		//assertEquals(-1, basis[1]);	// default
		//assertEquals(-2, basis[2]);	// default
		int[] newBasis = { 0, -2, -3 };
		...
		// FAILURE: does not work according to documentation
		// TODO: check later
		/*
		problem.resetBasis();
		problem.getBasis(bascolumn, false);	
		assertEquals(1, bascolumn[1]);
		assertEquals(2, bascolumn[2]);
		*/
	...
	public void testGetSensitivityRhs() throws Exception {
		...
		for (int i = 0; i < size; i++) {
			assertEquals(duals[i], ptrDuals[i], 0.0);
			assertEquals(dualsfrom[i], ptrDualsfrom[i], 0.0);
			assertEquals(dualstill[i], ptrDualstill[i], 0.0);
		}
		problem.deleteLp();
	}
	...
	public void testGetSensitivityObj() throws Exception {
		...
		assertEquals(0.5, objfrom[0], 0.0);
		assertEquals(problem.getInfinite(), objtill[0], 0.0);
		assertEquals(0.0, objfrom[1], 0.0);
		assertEquals(2.0, objtill[1], 0.0);
		for (int i = 0; i < size; i++) {
			assertEquals(objfrom[i], ptrObjfrom[i], 0.0);
			assertEquals(objtill[i], ptrObjtill[i], 0.0);
		}
		problem.deleteLp();
	}
	...
	public void testGetSensitivityObjex() throws Exception {
		...
		assertEquals(2.0, objtill[1], 0.0);
		for (int i = 0; i < size; i++) {
			assertEquals(objfrom[i], ptrObjfrom[i], 0.00001);
			assertEquals(objtill[i], ptrObjtill[i], 0.00001);
			assertEquals(objfromvalue[i], ptrObjfromvalue[i], 0.00001);
			assertEquals(objtillvalue[i], ptrObjtillvalue[i], 0.00001);
		}
		problem.deleteLp();
	}
	...
	public void testDefaultBasis() throws Exception {
	...
	public void testLogListener() throws Exception {
		...
		problem.deleteLp();
		// TODO: this is not working. logfunc never gets called. Check later.
		//assertTrue(listener.numCalls > 0);
	}
