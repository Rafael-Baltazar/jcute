 ...
 * Signature: (I)V
 */
JNIEXPORT void JNICALL Java_lpsolve_LpSolve_setFree
  (JNIEnv *env, jobject obj, jint colnr)
{
	lprec* lp = get_lp(env, obj);
	unsigned char rc = set_free(lp, colnr);
	if (rc == FALSE) {
		throw_exception_with_status(env, lp, "set_free");
	}
}
 ...
 * Signature: (I)Z
 */
JNIEXPORT jboolean JNICALL Java_lpsolve_LpSolve_isFree
  (JNIEnv *env, jobject obj, jint colnr)
{
	lprec* lp = get_lp(env, obj);
	return ((is_free(lp, colnr) == TRUE) ? JNI_TRUE : JNI_FALSE);
}
...
JNIEXPORT void JNICALL Java_lpsolve_LpSolve_setPresolve
  (JNIEnv *env, jobject obj, jint doPresolve)
{
	lprec* lp = get_lp(env, obj);
	set_presolve(lp, doPresolve);
}
 ...
 * Signature: ()I
 */
JNIEXPORT jint JNICALL Java_lpsolve_LpSolve_getTotalIter
  (JNIEnv *env, jobject obj)
{
	lprec* lp = get_lp(env, obj);
 ...
 * Signature: ()I
 */
JNIEXPORT jint JNICALL Java_lpsolve_LpSolve_getTotalNodes
  (JNIEnv *env, jobject obj)
{
	lprec* lp = get_lp(env, obj);
  ...
  (JNIEnv *env, jobject obj, jintArray bascolumn, jboolean nonbasic)
{
	...
	get_basis(lp, (int *)c_bascolumn, (nonbasic == JNI_TRUE) ? TRUE : FALSE);
