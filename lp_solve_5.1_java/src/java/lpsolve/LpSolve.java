...
public class LpSolve {
	...
	public static final int PRESOLVE_AGGREGATE       = 8;
	public static final int PRESOLVE_SPARSER        = 16;
	public static final int PRESOLVE_SOS            = 32;
	public static final int PRESOLVE_REDUCEMIP      = 64;
	public static final int PRESOLVE_DUALS         = 128;
	public static final int PRESOLVE_SENSDUALS     = 256;
	public static final int PRESOLVE_LASTMASKMODE  = (PRESOLVE_DUALS - 1);

	/* Basis crash options */
	public static final int CRASH_NOTHING            = 0;
	public static final int CRASH_NONBASICBOUNDS     = 1;
	public static final int CRASH_MOSTFEASIBLE       = 2;
	public static final int CRASH_LEASTDEGENERATE    = 3;
	...
	public static final int ANTIDEGEN_DEFAULT      = (ANTIDEGEN_FIXEDVARS | ANTIDEGEN_STALLING | ANTIDEGEN_INFEASIBLE);
	...
	public static final int IMPROVE_FTRAN   = 1;
	public static final int IMPROVE_BTRAN   = 2;
	public static final int IMPROVE_SOLVE    = (IMPROVE_FTRAN + IMPROVE_BTRAN);
	public static final int IMPROVE_INVERSE  = 4;
	...
	public static final int SCALE_FUTURE1            = 5;
	public static final int SCALE_FUTURE2            = 6;
	...
	public static final int SCALE_MAXTYPE            = (SCALE_QUADRATIC-1);
	...
	public static final int PRICE_AUTOPARTIALCOLS  = 256;    /* Detect and use data on the block structure of the model */
	public static final int PRICE_AUTOPARTIALROWS  = 512;    /* Detect and use data on the block structure of the model */
	...
	public static final int PRICE_AUTOPARTIAL  = PRICE_AUTOPARTIALCOLS + PRICE_AUTOPARTIALROWS;    
	...
	public static final int NODE_STRATEGYMASK        = NODE_USERSELECT;  /* Mask for B&B strategies */
	...
	public static final int NODE_GUBMODE           = 512;
	...
	public static final int NODE_PSEUDOFEASSELECT   = (NODE_PSEUDONONINTSELECT+NODE_WEIGHTREVERSEMODE);
	 ...
	 * Passed in arrays must be allocated by the caller of the method.
	 */
	public native void getColumn(int columnrnr, double[] column) throws LpSolveException;
	 ...
	 */
	public native void setFree(int colnr) throws LpSolveException;

	/**
	 * Returns if the variable is free.
	 */
	public native boolean isFree(int colnr);
	 ...
	 */
	public native void setPresolve(int doPresolve);
	 ...
	 */
	public native int getTotalIter();	
	 ...
	 */
	public native int getTotalNodes();	
	 ...
	 */
	public native void getBasis(int[] bascolumn, boolean nonbasic);
