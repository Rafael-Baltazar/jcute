...
//#define Prod_xA_RoundAbsolute       /* Can be disabled with relative rounding */
...
STATIC int prod_Ax(lprec *lp, int *coltarget, REAL *input, int *nzinput, int range, REAL roundzero, REAL multfactor, REAL *output, int *nzoutput);
STATIC int prod_xA(lprec *lp, int *coltarget, REAL *input, int *nzinput, int range, REAL roundzero, REAL ofscalar, REAL *output, int *nzoutput);
STATIC MYBOOL prod_xA2(lprec *lp, int *coltarget, REAL *prow, int prange, REAL proundzero, int *pnzprow,
