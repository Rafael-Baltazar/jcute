...
rem rc lpsolve.rc
%c% -I.. -I../bfp -I../bfp/bfp_etaPFI -I../colamd -s -O3 -shared -mno-cygwin -enable-stdcall-fixup -D_USRDLL -DWIN32 -DYY_NEVER_INTERACTIVE -DPARSER_LP %src% ..\lp_solve.def -o lpsolve51.dll

%c% -I.. -I../bfp -I../bfp/bfp_etaPFI -I../colamd -s -O3 -shared -D_USRDLL -DWIN32 -DYY_NEVER_INTERACTIVE -DPARSER_LP %src% -o liblpsolve51.so
